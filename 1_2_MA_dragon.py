...
Desc1 = pd.read_csv(str(PATH / Path('dragon_desc.csv')), sep=';')
Desc2 = pd.read_csv(str(PATH / Path('dragon_desc.csv')), sep=';')
...
buscarv_DB.to_csv("data/buscarv_DB_dragon.csv", sep=";", index=False)
...
buscarv_DB = buscarv_DB.drop(columns=['SMILES_y', 'SMILES_x'])
...
tabla_con_ref.to_csv('MA_table_dragon.csv', header=True, index=False)